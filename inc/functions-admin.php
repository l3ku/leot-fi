...
function portfolio_add_admin_page() {
    ...
    add_submenu_page('portfolio_theme_settings', __('Portfolio Social Settings', 'leotoikka'), __('Social', 'leotoikka'), 'manage_options', 'portfolio_theme_settings', 'portfolio_create_social_page');
    add_submenu_page('portfolio_theme_settings', __('Portfolio Page Settings', 'leotoikka'), __('Pages', 'leotoikka'), 'manage_options', 'portfolio_page_settings', 'portfolio_create_pages_page');
